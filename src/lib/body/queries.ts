 ...
 * resolved for every stored photo. Only the Body list/timeline page needs
 * the *full* history — Home, the body/[date] detail page, and Calendar all
 * have narrower variants below so they aren't paying to resolve signed
 * URLs for photos they never render.
 */
